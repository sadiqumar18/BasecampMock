...
class AttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attachment" do
    assert_difference('Attachment.count') do
      post attachments_url, params: { attachment: { file_name: @attachment.file_name, project_id: @attachment.project_id, uploaded_by: @attachment.uploaded_by } }
    end
  ...
  test "should update attachment" do
    patch attachment_url(@attachment), params: { attachment: { file_name: @attachment.file_name, project_id: @attachment.project_id, uploaded_by: @attachment.uploaded_by } }
